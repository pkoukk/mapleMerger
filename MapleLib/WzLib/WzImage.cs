...
namespace MapleLib.WzLib
{
    ...
    public class WzImage : WzObject, IPropertyContainer
    {
        ...
        internal byte unk_GMS230 = 0; // something something added in gms v230
        ...
        internal WzImage(string name, WzBinaryReader reader, int checksum, byte unk_GMS230)
        {
            this.name = name;
            this.reader = reader;
            this.blockStart = (int)reader.BaseStream.Position;
            this.checksum = checksum;
            this.unk_GMS230 = unk_GMS230;
        }
